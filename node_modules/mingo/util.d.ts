...
export declare function isObject(v: AnyVal): boolean;
...
export declare function isNull(v: AnyVal): boolean;
export declare function isUndefined(v: AnyVal): boolean;
export declare const inArray: (arr: RawArray, item: AnyVal) => boolean;
 ...
 */
export declare function intersection(a: RawArray, b: RawArray, hashFunction?: HashFunction): RawArray;
/**
 ...
 */
export declare function union(xs: RawArray, ys: RawArray): RawArray;
/**
 * Flatten the array
 *
 ...
 * @param {*} b
 */
export declare function compare(a: AnyVal, b: AnyVal): CompareResult;
/**
