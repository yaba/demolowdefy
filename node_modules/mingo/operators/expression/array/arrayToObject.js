...
function $arrayToObject(obj, expr, options) {
    var arr = core_1.computeValue(obj, expr, null, options);
    ...
    return arr.reduce(function (newObj, val) {
        if (val instanceof Array && val.length == 2) {
            ...
            var valObj = val;
            util_1.assert(util_1.isObject(valObj) && util_1.has(valObj, "k") && util_1.has(valObj, "v"), "$arrayToObject expression is invalid.");
