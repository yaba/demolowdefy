 ...
 */
export declare function remove(collection: Collection, criteria: RawObject, options?: Options): RawObject[];
/**
 ...
 */
export declare function aggregate(collection: Source, pipeline: Array<RawObject>, options?: Options): RawArray;
